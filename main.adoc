...
It is very convenient to use `java.nio.charset.StandardCharsets` (introduced in JDK7, see https://docs.oracle.com/javase/7/docs/api/java/nio/charset/StandardCharsets.html[javadoc]):
...
This is the big new feature of Java10.
...
NOTE: it is important to say that *you don’t need modules to run on Java9*, classpath is
still supported.
