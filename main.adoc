...
The last point is critical, since now in order to use Oracle JDK11 in production you have to subscribe
...
https://blog.joda.org/[Stephen Colebourne] has written quite
a lot https://blog.joda.org/2018/09/do-not-fall-into-oracles-java-11-trap.html[about these topics].
