...
Describing any of these items is beyond the scope of this document, especially Project Jigsaw (modules).
...
`Version` it's a value object and it is `Comparable<Version>`. It is even possible to create a `Version` instance
using an externally provided version string:
